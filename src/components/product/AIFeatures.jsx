...
<p className="text-gray-300 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed">
  Below is a comprehensive overview of the intelligent capabilities
  integrated into our platform. These AI-powered modules automate gate
  operations, optimize yard traffic, enable predictive decision-making,
  and deliver real-time operational visibility across the logistics
  ecosystem.
</p>
        </motion.div>
      </section>

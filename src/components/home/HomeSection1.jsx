                  ...
                  >
                    ...
                    >
                      ...
                      <div className="relative mb-6">
                        ...
                        {/* Glow effect */}
                        <div
                          className={`absolute -inset-4 ${service.iconColor.replace("text-", "bg-")}/10 rounded-full blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500`}
                        ></div>
                      </div>
